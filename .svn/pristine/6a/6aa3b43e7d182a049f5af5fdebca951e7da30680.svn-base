            ...
            <ul class="product-nav list-style-none">
                <li class="product-nav-prev">
                    ...
                    <span class="product-nav-popup">
                        <img src="{{ asset('images/products/product-nav-prev.jpg') }}" alt="Product" width="110"
                            height="110" />
                ...
                <li class="product-nav-next">
                    ...
                    <span class="product-nav-popup">
                        <img src="{{ asset('images/products/product-nav-next.jpg') }}" alt="Product" width="110"
                            height="110" />
                                    ...
                                    <div class="product-gallery product-gallery-sticky">
                                        ...
                                        'navigation': {
                                            ...
                                            <div class="swiper-wrapper row cols-1 gutter-no">
                                                @foreach ($product_multi_images as $product_multi_image)
                                                    <div class="swiper-slide">
                                                        <figure class="product-image">
                                                            <img src="{{ asset($product_multi_image->product_image) }}"
                                                                data-zoom-image="{{ asset($product_multi_image->product_image) }}"
                                ...
                                <div class="col-md-6 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        ...
                                        <div class="product-bm-wrapper">
                                            <figure class="brand">
                                                <img src="{{ asset($product->brand_image) }}" alt="Brand" width="102"
                                                    height="48" />
                                            </figure>
                                            <div class="product-meta">
                                                <div class="product-categories">
                                                    ...
                                                    <span class="product-category"><a
                                                            href="#">{{ $product->category_name }}</a></span>
                                                </div>
                                        ...
                                        <div class="product-price"><ins
                                                class="new-price">₹{{ $product->product_price }}</ins></div>
                                        ...
                                        <div class="fix-bottom product-sticky-content sticky-content">
                                            <div class="product-form container">
                                                ...
                                                <button class="btn btn-secondary btn-cart">
                                                    {{-- <i class="w-icon-cart"></i> --}}
                                                    <span>Buy Now</span>
                                                </button>
                                            </div>
                                        ...
                                        <div class="col-md-6 mb-5">
                                            <div class="banner banner-video product-video br-xs">
                                                <figure class="banner-media">
                                                    <a href="#">
                                                        <img src="{{ asset('images/products/video-banner-610x300.jpg') }}"
                                                            alt="banner" width="610" height="300"
                                                            style="background-color: #bebebe;">
                                                    </a>
                                                    <a class="btn-play-video btn-iframe"
                                                        href="{{ asset('video/memory-of-a-woman.mp4') }}"></a>
                                                </figure>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6 mb-4">
                                            <figure class="vendor-banner br-sm">
                                                <img src="{{ asset('images/products/vendor-banner.jpg') }}"
                                        ...
                                        <div class="col-md-6 pl-2 pl-md-6 mb-4">
                                            <div class="vendor-user">
                                                <figure class="vendor-logo mr-4">
                                                    <a href="#">
                                                        <img src="{{ asset('images/products/vendor-logo.jpg') }}"
                                            ...
                                            <div class="tab-pane active" id="show-all">
                                                <ul class="comments list-style-none">
                                                    <li class="comment">
                                                        <div class="comment-body">
                                                            <figure class="comment-avatar">
                                                                <img src="{{ asset('images/agents/1-100x100.png') }}"
                                                            ...
                                                            <div class="comment-content">
                                                                ...
                                                                <div class="comment-action">
                                                                    ...
                                                                    <div class="review-image">
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{ asset('images/products/default/review-img-1.jpg') }}"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{ asset('images/products/default/review-img-1-800x900.jpg') }}" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <li class="comment">
                                                        <div class="comment-body">
                                                            <figure class="comment-avatar">
                                                                <img src="{{ asset('images/agents/2-100x100.png') }}"
                                                                    alt="Commenter Avatar" width="90" height="90">
                                                            </figure>
                                                            <div class="comment-content">
                                                                <h4 class="comment-author">
                                                                ...
                                                                <div class="comment-action">
                                                                    ...
                                                                    <div class="review-image">
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{ asset('images/products/default/review-img-2.jpg') }}"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{ asset('images/products/default/review-img-2.jpg') }}" />
                                                                            </figure>
                                                                        </a>
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{ asset('images/products/default/review-img-3.jpg') }}"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{ asset('images/products/default/review-img-3.jpg') }}" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <li class="comment">
                                                        <div class="comment-body">
                                                            <figure class="comment-avatar">
                                                                <img src="{{ asset('images/agents/3-100x100.png') }}"
                                                                    alt="Commenter Avatar" width="90" height="90">
                                                            </figure>
                                                            <div class="comment-content">
                                                                <h4 class="comment-author">
                                                                        ...
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{ asset('images/products/default/review-img-1.jpg') }}"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{ asset('images/products/default/review-img-1.jpg') }}" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{ asset('images/products/default/review-img-3.jpg') }}"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{ asset('images/products/default/review-img-3-800x900.jpg') }}" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{ asset('images/products/default/review-img-2.jpg') }}"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{ asset('images/products/default/review-img-2-800x900.jpg') }}" />
                                                                            </figure>
                                                                        </a>
                                                                        <a href="#">
                                                                            <figure>
                            ...
                            'breakpoints': {
                                ...
                                <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('images/products/default/1-1.jpg') }}" alt="Product"
                                                    width="300" height="338" />
                                                <img src="{{ asset('images/products/default/1-2.jpg') }}" alt="Product"
                                                    width="300" height="338" />
                                            </a>
                                    ...
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('images/products/default/2.jpg') }}" alt="Product"
                                                    width="300" height="338" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('images/products/default/3.jpg') }}" alt="Product"
                                                    width="300" height="338" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('images/products/default/4-1.jpg') }}" alt="Product"
                                                    width="300" height="338" />
                                                <img src="{{ asset('images/products/default/4-2.jpg') }}" alt="Product"
                                                    width="300" height="338" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                            ...
                            'breakpoints': {
                                ...
                                <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('images/products/default/5.jpg') }}" alt="Product"
                                                    width="300" height="338" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('images/products/default/6.jpg') }}" alt="Product"
                                                    width="300" height="338" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('images/products/default/7-1.jpg') }}" alt="Product"
                                                    width="300" height="338" />
                                                <img src="{{ asset('images/products/default/7-2.jpg') }}" alt="Product"
                                                    width="300" height="338" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('images/products/default/8.jpg') }}" alt="Product"
                                                    width="300" height="338" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                            ...
                            <div class="sticky-sidebar">
                                ...
                                <div class="widget widget-banner mb-9">
                                    <div class="banner banner-fixed br-sm">
                                        <figure>
                                            <img src="{{ asset('images/shop/banner3.jpg') }}" alt="Banner"
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="widget-col swiper-slide">
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{ asset('images/shop/13.jpg') }}"
                                                    ...
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{ asset('images/shop/14.jpg') }}"
                                                                    alt="Product" width="100" height="113" />
                                                            </a>
                                                        </figure>
                                                        <div class="product-details">
                                                    ...
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{ asset('images/shop/15.jpg') }}"
                                                                    alt="Product" width="100" height="113" />
                                                            </a>
                                                        </figure>
                                                        <div class="product-details">
                                                ...
                                                <div class="widget-col swiper-slide">
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{ asset('images/shop/16.jpg') }}"
                                                                    alt="Product" width="100" height="113" />
                                                            </a>
                                                        </figure>
                                                        <div class="product-details">
                                                    ...
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{ asset('images/shop/17.jpg') }}"
                                                                    alt="Product" width="100" height="113" />
                                                            </a>
                                                        </figure>
                                                        <div class="product-details">
                                                    ...
                                                    <div class="product product-widget">
                                                        <figure class="product-media">
                                                            <a href="#">
                                                                <img src="{{ asset('images/shop/18.jpg') }}"
                                                                    alt="Product" width="100" height="113" />
                                                            </a>
                                                        </figure>
                                                        <div class="product-details">
