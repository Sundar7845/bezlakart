    ...
    public function storeCreate(Request $request)
    {
        $request->validate(
            [
                ...
                'fileStoreLogo' => $request->hdStoreId == null ? 'required|dimensions:height=124,width=320' : 'dimensions:height=124,width=320,fileBrandImage',
            ...
            [
                ...
                'fileStoreLogo.dimensions' => 'Please upload in dimension 124 * 320 px',
        ...
        try {
            if ($request->hdStoreId == null) {
                ...
                //User Name
                $OwnerName = $request->txtOwnerFirstName . $request->txtOwnerLastName;
                //user Create
                $this->userCreate(
                    $request->txtStoreName,
                    $request->txtEmail,
                    $request->txtPassword,
                    $store->id,
                    $OwnerName,
