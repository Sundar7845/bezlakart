...
if (isset($maintenance) ? $maintenance->is_maintenace_mode == 0 : '') {
    ...
    Route::get('/categorywise/product/{id}', [App\Http\Controllers\Frontend\Shop\FilterwiseProductController::class, 'categoryWiseProducts'])->name('categorywiseproduct');
    Route::get('/getbrandwise/product', [App\Http\Controllers\Frontend\Shop\FilterwiseProductController::class, 'brandWiseProducts'])->name('brandwiseproduct');
    ...
    Route::group(['middleware' => ['auth', 'prevent-back-history']], function () {
        ...
        //Wishlist
        Route::get('/wishlist/{id?}', [App\Http\Controllers\Frontend\Wishlist\WishlistController::class, 'wishList'])->name('wishlist');
        Route::get ('/wishlists/product', [App\Http\Controllers\Frontend\Wishlist\WishlistController::class, 'WishListStore'])->name('wishliststore');
