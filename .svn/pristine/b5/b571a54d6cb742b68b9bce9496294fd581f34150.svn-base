...
<div class="row">
    <div class="col-12">
        <div class="justify-content-between d-flex align-items-center mt-3 mb-4">
            <h5 id="heading">Main Category</h5>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Main Category Image<span
                                                class="text-danger"><small>(190 * 190 px)</small>*</span></label>
                                        <input type="file" class="form-control" name="fileMainCategoryImage"
                                            id="fileMainCategoryImage" width="190" height="190" required>
                                    </div>
                                    <div class="img mt-2">
                                        <img src="{{ asset('images/no-image.jpg') }}" id="previewImage" width="100"
                                            height="100">
                                    </div>
                                    @error('fileMainCategoryImage')
                                        <div class="text-danger">{{ $errors->first('fileMainCategoryImage') }}
                                        </div>
                                    @enderror
                                    <span class="error"></span>
                                </div>
