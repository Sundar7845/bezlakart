            ...
            <div class="container">
                        ...
                        <div class="swiper-wrapper row gutter-no cols-xl-7 cols-lg-6 cols-md-4 cols-sm-3 cols-2">
                            @foreach ($brands as $brand)
                                <div class="swiper-slide">
                                    <figure>
                                        <img src="{{ asset($brand->brand_image) }}" alt="Brand" width="160"
                                            height="90" />
                                    </figure>
                                </div>
                            @endforeach
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="{{ url('/categorywise/product/' . $maincategory->id) }}">
                                                <img src="{{ asset($maincategory->main_category_image) }}" alt="Categroy"
                                        ...
                                        <div class="category-content">
                                            <h4 class="category-name">
                                                <a
                                                    href="{{ url('/categorywise/product/' . $maincategory->id) }}">{{ $maincategory->main_category_name }}</a>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="shop-content row gutter-lg mb-10">
                        ...
                        <div class="sidebar-content scrollable">
                            ...
                            <div class="sticky-sidebar">
                                <div class="filter-actions">
                                    <label>Filter :</label>
                                    <a href="{{ route('shop') }}" class="btn btn-dark btn-link">Clean All</a>
                                </div>
                                ...
                                <div class="widget widget-collapsible">
                                    ...
                                    <ul class="widget-body filter-items item-check mt-1">
                                        @foreach ($brands as $brand)
                                            <li id="brand_filter"><input type="checkbox" class="chkBrandName"
                                                    id="chkBrandName{{ $brand->id }}"
                                                    onclick="getbrand({{ $brand->id }});">{{ $brand->brand_name }}</li>
                                        @endforeach
                                    </ul>
                                </div>
                                <!-- End of Collapsible Widget -->
                    ...
                    <div class="main-content">
                        <nav class="toolbox sticky-toolbox sticky-content fix-top">
                            ...
                            <div class="toolbox-right">
                                ...
                                {{-- <div class="toolbox-item toolbox-layout">
                                    <a href="{{ route('shop') }}" class="icon-mode-grid btn-layout active">
                                        <i class="w-icon-grid"></i>
                                    </a>
                                    <a href="{{ route('shoplist') }}" class="icon-mode-list btn-layout">
                        ...
                        @if ($products->isEmpty())
                            <img src="{{ asset('images/no_result.gif') }}">
                        @else
                            <div class="product-wrapper row cols-md-3 cols-sm-2 cols-2" id="product_page">
                                            ...
                                            <figure class="product-media">
                                                <a href="{{ url('/products/detail/' . $product->id) }}">
                                                    <img src="{{ asset($product->product_image) }}" alt="Product"
                                                        id="product_image" width="300" height="338" />
                                                </a>
                                                <div class="product-action-horizontal">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        @if ($product->is_favourite == 1) w-icon-heart-full 
                                                        @else w-icon-heart @endif"
                                                        onclick="wishlist('{{ $product->id }}')" title="Wishlist"></a>
                                            ...
                                            <div class="product-details">
                                                ...
                                                <div class="product-pa-wrapper">
                                                    ...
                                                    <div class="product-price">
                                                        {{ isset($businessSetting) ? $businessSetting->currency_symbol : ₹ }}{{ $product->product_price }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
@endsection
@section('footer')
    <script src="{{ asset('js/frontend/shop/shop.js') }}"></script>
