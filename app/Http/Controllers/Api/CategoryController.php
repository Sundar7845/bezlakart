    ...
    function getCategory()
    {
        try {
            ...
            foreach ($category as $item) {
                ...
                $categoryDetails['main_category_name'] = $item->main_category_name;
    ...
    function getSubCategory()
    {
        try {
            ...
            foreach ($subCategory as $item) {
                ...
                $subCategoryDetails['main_category_name'] = $item->main_category_name;
                $subCategoryDetails['category_id'] = $item->category_id;
                $subCategoryDetails['category_name'] = $item->category_name;
