...
class BannerController extends Controller
{
    ...
    function bannercreate(Request $request)
    {
        $request->validate([
            ...
            'ddlStore' => 'required',
            'fileBannerImage' => $request->hdBannerId == null ? 'required|dimensions:width=' . $request->hdWidth . ',height=' . $request->hdHeight . '' : 'dimensions:width=' . $request->hdWidth . ',height=' . $request->hdHeight . ',fileBannerImage'
        ], [
    ...
    {
        try {
            $banner = Banner::select('banners.*', 'banner_locations.banner_height', 'banner_locations.banner_width')
                ->join('banner_locations', 'banner_locations.id', 'banners.banner_location_id')
                ->where('banners.id', $id)
                ->first();
