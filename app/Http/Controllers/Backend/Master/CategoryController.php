    ...
    public function categoryCreate(Request $request)
    {
        $request->validate(
            [
                ...
                'fileCategoryImage' => ($request->hdCategoryId == null) ? 'required|dimensions:height=190,width=190' : 'dimensions:height=190,width=190,fileCategoryImage'
            ...
            [
                ...
                'fileCategoryImage.dimensions' => 'Please Upload Image in dimension 190 * 190 px',
