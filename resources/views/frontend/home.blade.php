...
@section('content')
    <main class="main">
        @php
            ...
            $mainbanners = Banner::where('is_active', 1)
                ->where('banner_location_id', 1)
                ->get();
            $middleBanner1 = Banner::where('is_active', 1)
                ->where('banner_location_id', 2)
                ->limit(2)
                ->get();
            $middleBanner2 = Banner::where('is_active', 1)
                ->where('banner_location_id', 3)
                ->limit(2)
                ->get();
            $middleBanner3 = Banner::where('is_active', 1)
                ->where('banner_location_id', 4)
                ->first();
            $leftBanner1 = Banner::where('is_active', 1)
                ->where('banner_location_id', 5)
                ->first();
            $leftBanner2 = Banner::where('is_active', 1)
                ->where('banner_location_id', 6)
                ->first();
            $leftBanner3 = Banner::where('is_active', 1)
                ->where('banner_location_id', 7)
                ->first();
                ...
                <div class="swiper-wrapper">
                    @foreach ($mainbanners as $mainbanner)
                        <div class="swiper-slide banner banner-fixed intro-slide intro-slide1">
                            <img src="{{ asset($mainbanner->banner_image) }}" style="height:520px;">
                            <div class="container">
        ...
        <div class="container">
            ...
            <div class="row category-banner-wrapper appear-animate pt-6 pb-8">
                @foreach ($middleBanner1 as $middleBanner)
                    <div class="col-md-6 mb-4">
                        <div class="banner banner-fixed br-xs">
                            <figure>
                                <img src="{{ asset($middleBanner->banner_image) }}" alt="Category Banner" width="610"
                ...
                {{-- <div class="col-md-6 mb-4">
                    <div class="banner banner-fixed br-xs">
                        <figure>
                            <img src="{{ asset('images/demos/demo1/categories/1-2.jpg') }}" alt="Category Banner"
                                        ...
                                        <div class="product product-single row">
                                                        ...
                                                        <div class="swiper-wrapper row cols-1 gutter-no">
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('images/demos/demo1/products/1-1-600x675.jpg') }}"
                                                            ...
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('images/demos/demo1/products/1-2-600x675.jpg') }}"
                                                            ...
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('images/demos/demo1/products/1-3-600x675.jpg') }}"
                                                            ...
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('images/demos/demo1/products/1-4-600x675.jpg') }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="product-details scrollable">
                                                    <h2 class="product-title mb-1"><a href="">Coat Pool
                                                            Comfort Jacket</a></h2>
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="swiper-wrapper row cols-1 gutter-no">
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('images/demos/demo1/products/2-1-600x675.jpg') }}"
                                                            ...
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('images/demos/demo1/products/2-2-600x675.jpg') }}"
                                                            ...
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('images/demos/demo1/products/2-3-600x675.jpg') }}"
                                                            ...
                                                            <div class="swiper-slide">
                                                                <figure class="product-image">
                                                                    <img src="{{ asset('images/demos/demo1/products/2-4-600x675.jpg') }}"
                                    ...
                                    <div class="swiper-wrapper row cols-lg-1 cols-md-3">
                                        <div class="swiper-slide product-widget-wrap">
                                            <div class="product product-widget bb-no">
                                                <figure class="product-media">
                                                    <a href="">
                                                        <img src="{{ asset('images/demos/demo1/products/2-1.jpg') }}"
                                            ...
                                            <div class="product product-widget bb-no">
                                                <figure class="product-media">
                                                    <a href="">
                                                        <img src="{{ asset('images/demos/demo1/products/2-2.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget">
                                                <figure class="product-media">
                                                    <a href="">
                                                        <img src="{{ asset('images/demos/demo1/products/2-3.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                        ...
                                        <div class="swiper-slide product-widget-wrap">
                                            <div class="product product-widget bb-no">
                                                <figure class="product-media">
                                                    <a href="">
                                                        <img src="{{ asset('images/demos/demo1/products/2-4.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget bb-no">
                                                <figure class="product-media">
                                                    <a href="">
                                                        <img src="{{ asset('images/demos/demo1/products/2-5.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget">
                                                <figure class="product-media">
                                                    <a href="">
                                                        <img src="{{ asset('images/demos/demo1/products/2-6.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                        ...
                                        <div class="swiper-slide product-widget-wrap">
                                            <div class="product product-widget bb-no">
                                                <figure class="product-media">
                                                    <a href="">
                                                        <img src="{{ asset('images/demos/demo1/products/2-7.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget bb-no">
                                                <figure class="product-media">
                                                    <a href="">
                                                        <img src="{{ asset('images/demos/demo1/products/2-8.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                            ...
                                            <div class="product product-widget">
                                                <figure class="product-media">
                                                    <a href="">
                                                        <img src="{{ asset('images/demos/demo1/products/2-9.jpg') }}"
                                                            alt="Product" width="105" height="118" />
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                        ...
                        <div class="swiper-wrapper row cols-lg-6 cols-md-5 cols-sm-3 cols-2">
                            @foreach ($maincategorys as $maincategory)
                                <div class="swiper-slide category category-classic category-absolute overlay-zoom br-xs">
                                    <a href="{{ route('shop') }}" class="category-media">
                                        <img src="{{ $maincategory->main_category_image }}" alt="Category"
                                            width="130" height="130">
                                    </a>
                                    <div class="category-content">
                                        <h4 class="category-name">{{ $maincategory->main_category_name }}</h4>
                                        <a href="{{ route('shop') }}" class="btn btn-primary btn-link btn-underline">Shop
                                            Now</a>
                                    </div>
                                </div>
                            @endforeach
        ...
        <div class="container">
                    ...
                    <div class="row cols-xl-5 cols-md-4 cols-sm-3 cols-2">
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="">
                                        <img src="{{ asset('images/demos/demo1/products/3-1-1.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                        <img src="{{ asset('images/demos/demo1/products/3-1-2.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                    </a>
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="">
                                        <img src="{{ asset('images/demos/demo1/products/3-2.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="">
                                        <img src="{{ asset('images/demos/demo1/products/3-3.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="">
                                        <img src="{{ asset('images/demos/demo1/products/3-4-1.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                        <img src="{{ asset('images/demos/demo1/products/3-4-2.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="">
                                        <img src="{{ asset('images/demos/demo1/products/3-5.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="">
                                        <img src="{{ asset('images/demos/demo1/products/3-6-1.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                        <img src="{{ asset('images/demos/demo1/products/3-6-2.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="">
                                        <img src="{{ asset('images/demos/demo1/products/3-7.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="">
                                        <img src="{{ asset('images/demos/demo1/products/3-8-1.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                        <img src="{{ asset('images/demos/demo1/products/3-8-2.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="">
                                        <img src="{{ asset('images/demos/demo1/products/3-9.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                        ...
                        <div class="product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="">
                                        <img src="{{ asset('images/demos/demo1/products/3-10.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                            ...
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="">
                                        <img src="{{ asset('images/demos/demo1/products/3-6-1.jpg') }}" alt="Product"
                                            width="300" height="338" />
                                        <img src="images/demos/demo1/products/3-6-2.jpg" alt="Product" width="300"
                                            height="338" />
                                    </a>
                                    <div class="product-action-vertical">
                                        <a href="#" class="btn-product-icon btn-cart w-icon-cart"
            ...
            <div class="row category-cosmetic-lifestyle appear-animate mb-5">
                @foreach ($middleBanner2 as $middleBanner)
                    <div class="col-md-6 mb-4">
                        <div class="banner banner-fixed category-banner-1 br-xs">
                            <figure>
                                <img src="{{ asset($middleBanner->banner_image) }}" alt="Category Banner"
                            ...
                            <h3 class="banner-title font-weight-bolder text-capitalize text-white">Cosmetic
                                ...
                                <a href="{{ $middleBanner->banner_url }}"
                ...
                {{-- <div class="col-md-6 mb-4">
                    <div class="banner banner-fixed category-banner-2 br-xs">
                        <figure>
                            <img src="{{ asset('images/demos/demo1/categories/3-2.jpg') }}" alt="Category Banner"
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-4 mb-4">
                        <div class="banner h-100 br-sm"
                            style="background-image: url({{ $leftBanner1->banner_image }}); 
                        background-color: #ebeced;">
                            <div class="banner-content content-top">
                                ...
                                <a href="{{ $leftBanner1->banner_url }}" class="btn btn-dark btn-outline btn-rounded btn-sm">shop
                                    Now</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('images/demos/demo1/products/4-1.jpg') }}"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('images/demos/demo1/products/4-5-1.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                                <img src="{{ asset('images/demos/demo1/products/4-5-2.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('images/demos/demo1/products/4-2-1.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                                <img src="{{ asset('images/demos/demo1/products/4-2-2.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Women’s Fashion
                                                    Handbag </a></h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 60%;"></span>
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="{{ asset('images/demos/demo1/products/4-6.jpg') }}"
                                                    alt="Product" width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Gray Leather
                                                    Shoes</a></h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 60%;"></span>
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="images/demos/demo1/products/4-3.jpg" alt="Product"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Black Winter
                                                    Skating</a></h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 60%;"></span>
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="images/demos/demo1/products/4-7.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Men's Black
                                                    Wrist
                                                    Watch</a></h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="images/demos/demo1/products/4-4-1.jpg" alt="Product"
                                                    width="216" height="243" />
                                                <img src="images/demos/demo1/products/4-4-2.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Sport Women's
                                                    Wear</a></h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 60%;"></span>
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="images/demos/demo1/products/4-8.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Women’s Hiking
                                                    Hat</a></h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 60%;"></span>
            ...
            <div class="product-wrapper-1 appear-animate mb-8">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-4 mb-4">
                        <div class="banner h-100 br-sm"
                            style="background-image: url({{ $leftBanner2->banner_image }}); 
                    background-color: #252525;">
                            <div class="banner-content content-top">
                                ...
                                <a href="{{ $leftBanner2->banner_url }}" class="btn btn-white btn-outline btn-rounded btn-sm">shop
                                    now</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/5-1-1.jpg" alt="Product"
                                                    width="216" height="243" />
                                                <img src="images/demos/demo1/products/5-1-2.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/5-5.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/5-2-1.jpg" alt="Product"
                                                    width="216" height="243" />
                                                <img src="images/demos/demo1/products/5-2-2.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="{">Wash Machine</a>
                                            </h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 100%;"></span>
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/5-6.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Security
                                                    Guard</a>
                                            </h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/5-3.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">HD
                                                    Television</a>
                                            </h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/5-7.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">USB Receipt</a>
                                            </h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 100%;"></span>
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/5-4.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Data Transformer
                                                    Tool</a></h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 100%;"></span>
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/5-8.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Multi Functional
                                                    Apple iPhone</a></h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 100%;"></span>
            ...
            <div class="banner banner-fashion appear-animate br-sm mb-9"
                style="background-image: url('{{ url($middleBanner3->banner_image) }}');
            background-color: #383839;">
                <div class="banner-content align-items-center">
                    ...
                    <div class="content-right d-flex align-items-center flex-1 flex-wrap">
                        ...
                        <a href="{{ $middleBanner3->banner_url }}"
            ...
            <div class="product-wrapper-1 appear-animate mb-7">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-4 mb-4">
                        <div class="banner h-100 br-sm"
                            style="background-image: url({{ $leftBanner3->banner_image }}); 
                    background-color: #EAEFF3;">
                            <div class="banner-content content-top">
                                ...
                                <a href="{{ $leftBanner3->banner_url }}" class="btn btn-dark btn-outline btn-rounded btn-sm">shop
                                    now</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="swiper-wrapper row cols-xl-4 cols-lg-3 cols-2">
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/6-1.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/6-5.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/6-2-1.jpg" alt="Product"
                                                    width="216" height="243" />
                                                <img src="images/demos/demo1/products/6-2-2.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Kitchen
                                                    Table</a>
                                            </h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/6-6.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/6-3-1.jpg" alt="Product"
                                                    width="216" height="243" />
                                                <img src="images/demos/demo1/products/6-3-2.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Table Lamp</a>
                                            </h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 60%;"></span>
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/6-7.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Electric Frying
                                                    Pan</a></h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 100%;"></span>
                                ...
                                <div class="swiper-slide product-col">
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/6-4.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Latest Chair</a>
                                            </h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 100%;"></span>
                                    ...
                                    <div class="product-wrap product text-center">
                                        <figure class="product-media">
                                            <a href="">
                                                <img src="images/demos/demo1/products/6-8-1.jpg" alt="Product"
                                                    width="216" height="243" />
                                                <img src="images/demos/demo1/products/6-8-2.jpg" alt="Product"
                                                    width="216" height="243" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="">Automatic
                                                    Crusher</a></h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 100%;"></span>
            ...
            'breakpoints': {
                ...
                <div class="swiper-wrapper row gutter-no cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                    @foreach ($brands as $brand)
                        <div class="swiper-slide brand-col">
                            <figure class="brand-wrapper">
                                <img src="{{ $brand->brand_image }}" alt="Brand" width="410"
                                    height="186" />
                            </figure>
                            {{-- <figure class="brand-wrapper">
                        <img src="images/demos/demo1/brands/2.png" alt="Brand" width="410"
                            height="186" />
                    </figure> --}}
                        </div>
                    @endforeach
                    {{-- <div class="swiper-slide brand-col">
                    <figure class="brand-wrapper">
                        <img src="images/demos/demo1/brands/3.png" alt="Brand" width="410"
                            height="186" />
                    </figure>
                    <figure class="brand-wrapper">
                        <img src="images/demos/demo1/brands/4.png" alt="Brand" width="410"
                            height="186" />
                    </figure>
                </div>
                <div class="swiper-slide brand-col">
                    <figure class="brand-wrapper">
                        <img src="images/demos/demo1/brands/5.png" alt="Brand" width="410"
                            height="186" />
                    </figure>
                    <figure class="brand-wrapper">
                        <img src="images/demos/demo1/brands/6.png" alt="Brand" width="410"
                            height="186" />
                    </figure>
                </div>
                <div class="swiper-slide brand-col">
                    <figure class="brand-wrapper">
                        <img src="images/demos/demo1/brands/7.png" alt="Brand" width="410"
                            height="186" />
                    </figure>
                    <figure class="brand-wrapper">
                        <img src="images/demos/demo1/brands/8.png" alt="Brand" width="410"
                            height="186" />
                    </figure>
                </div>
                <div class="swiper-slide brand-col">
                    <figure class="brand-wrapper">
                        <img src="images/demos/demo1/brands/9.png" alt="Brand" width="410"
                            height="186" />
                    </figure>
                    <figure class="brand-wrapper">
                        <img src="images/demos/demo1/brands/10.png" alt="Brand" width="410"
                            height="186" />
                    </figure>
                </div>
                <div class="swiper-slide brand-col">
                    <figure class="brand-wrapper">
                        <img src="images/demos/demo1/brands/11.png" alt="Brand" width="410"
                            height="186" />
                    </figure>
                    <figure class="brand-wrapper">
                        <img src="images/demos/demo1/brands/12.png" alt="Brand" width="410"
                            height="186" />
                    </figure>
                </div> --}}
                </div>
