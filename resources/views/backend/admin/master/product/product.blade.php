...
<div class="row">
    <div class="col-12">
        ...
        <form action="{{ route('productcreate') }}" method="POST" enctype="multipart/form-data" name="product">
            ...
            <input type="hidden" name="hdProductImage" id="hdProductImage" value="">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="txtProductName" name="txtProductName"
                                    value="{{ old('txtProductName') }}" title="Enter Product Name"
                            ...
                            <div>
                                ...
                                <textarea name="txtProductDescription" id="ckeditor-classic" class="txtProductDescription" cols="30" rows="10"
                                    required>{{ old('txtProductDescription') }}</textarea>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                <h5 class="fs-14 mb-1">Product Image <span class="text-danger"><small>(800 * 900
                                            px)</small></span>
                                </h5>
                                    ...
                                    <div class="position-relative d-inline-block">
                                        ...
                                        <div class="avatar-lg">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="{{ asset('/images/no-image.jpg') }}" id="product-img"
                            ...
                            <div>
                                <h5 class="fs-14 mb-1">Product Gallery <span class="text-danger"><small>(800 * 900
                                            px)</small></span>
                                </h5>
                                <span class="badge badge-soft-dark mb-1">NOTE: please select all images at same
                                    time</span>
                                        ...
                                        <div class="border rounded">
                                            <div class="d-flex p-2">
                                                ...
                                                <div class="flex-shrink-0 ms-3">
                                                    <button data-dz-remove id="delete"
                                                ...
                                                <select class="form-select js-example-basic-single" id="ddlStoreName"
                                                    ...
                                                    @foreach ($store as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ old('ddlStoreName') == $item->id ? 'selected' : '' }}>
                                                            {{ $item->store_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select js-example-basic-single" id="ddlBrandName"
                                                    ...
                                                    @foreach ($brand as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ old('ddlBrandName') == $item->id ? 'selected' : '' }}>
                                                            {{ $item->brand_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="ddlDiscount" name="ddlDiscount"
                                                    ...
                                                    @foreach ($discountTypes as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ old('ddlDiscount') == $item->id ? 'selected' : '' }}>
                                                            {{ $item->discount_type }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="txtCommissionAmt"
                                                    ...
                                                    value="{{ old('txtCommissionAmt') }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select js-example-basic-single" name="ddlMainCategory"
                                    ...
                                    @foreach ($mainCategory as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('ddlMainCategory') == $item->id ? 'selected' : '' }}>
