...
<head>
    ...
    <meta charset="utf-8" />
    <title>Log In | BezlaKart | Admin Dashboard</title>
...
<body>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4 auth-one-bg h-100">
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <h3 class="d-block text-white">BezlaKart</h3>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Sign in to continue BezlaKart.</p>
                                        </div>
                                            ...
                                            <form action="{{ route('admin.login') }}" method="POST"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="txtMobile"
                                                        id="txtMobile" placeholder="Enter mobile" title="Enter mobile"
                                                        required>
                                                    <div class="invalid-feedback">
                                                        Please enter login mobile.
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="password" class="form-control" name="txtPassword"
                                                        id="txtPassword" placeholder="*********" title="Enter password"
                                                        required>
                                                    <div class="invalid-feedback">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                ...
                                </script> BezlaKart. Crafted with <i
                                    class="mdi mdi-heart text-danger"></i> by Adhoc Softwares
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        @if (Session::has('message'))
            ...
            switch (type) {
                case 'info':
                    showToast(type, message, "blue");
                    break;
                case 'success':
                    showToast(type, message, "green");
                    break;
                case 'warning':
                    showToast(type, message, "orange");
                    break;
                case 'error':
                    showToast(type, message, "red");
                    break;
            }
        @endif
    </script>
