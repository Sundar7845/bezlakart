...
Route::group(['middleware' => ['admin', 'prevent-back-history']], function () {
    ...
    Route::post('profile', [App\Http\Controllers\Backend\Profile\ProfileController::class, 'profileUpdate'])->name('profileupdate');
    ...
    //orders
    //All Orders
    Route::get('allorders', [App\Http\Controllers\Backend\Order\AllOrderController::class, 'allOrders'])->name('allorders');

    //Pending Orders
    Route::get('pendingorders', [App\Http\Controllers\Backend\Order\PendingOrderController::class, 'pendingOrders'])->name('pendingorders');

    //Accepted Orders
    Route::get('acceptedorders', [App\Http\Controllers\Backend\Order\AcceptedOrderController::class, 'acceptedOrders'])->name('acceptedorders');

    //Processing Orders
    Route::get('processingorder', [App\Http\Controllers\Backend\Order\ProcessingOrderController::class, 'processingOrders'])->name('processingorders');

    //Failed Controller
    Route::get('faildorder', [App\Http\Controllers\Backend\Order\FailedOrderController::class, 'failedOrders'])->name('failedorders');

    //Cancelled Orders
    Route::get('cancelledorder', [App\Http\Controllers\Backend\Order\CancelledOrderController::class, 'cancelledOrders'])->name('concelledorders');

    //Refunded Orders
    Route::get('refundedorders', [App\Http\Controllers\Backend\Order\RefundedOrdersController::class, 'refundedOrders'])->name('refundedorders');

    //Dlivered Orders
    Route::get('deliverdorders', [App\Http\Controllers\Backend\Order\DeliveredOrdersController::class, 'deliveredOrders'])->name('deliveredorders');

    //Gold Chit
    Route::get('goldplan', [App\Http\Controllers\Backend\GoldChit\GoldPlanController::class, 'goldPlan'])->name('goldplan');
    Route::post('goldplancreate', [App\Http\Controllers\Backend\GoldChit\GoldPlanController::class, 'goldPlanCreate'])->name('goldplancreate');
    Route::get('getgoldplan', [App\Http\Controllers\Backend\GoldChit\GoldPlanController::class, 'getGoldPlans'])->name('getgoldplan');
    Route::get('goldplans/{id}', [App\Http\Controllers\Backend\GoldChit\GoldPlanController::class, 'getGoldPlanById'])->name('getgoldplanbyid');
    Route::get('deletegoldplan/{id}', [App\Http\Controllers\Backend\GoldChit\GoldPlanController::class, 'deleteGoldPlan'])->name('deletegoldplan');
    Route::post('goldplan/{id}/{status}', [App\Http\Controllers\Backend\GoldChit\GoldPlanController::class, 'goldPlanActiveStatus'])->name('goldplanactivestatus');
});
